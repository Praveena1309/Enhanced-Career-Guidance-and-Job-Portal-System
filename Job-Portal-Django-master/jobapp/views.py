...
def home_view(request):
    ...
    'page_obj': page_obj,
    'qulificationmodel':qulificationmodel
    }
    print('ok')
...
def search_result_view(request):
    ...
    #     location__icontains=location) | Job.objects.filter(title__icpage_objontains=text) | Job.objects.filter(company_name__icontains=text)
